...
from app.utils.fixes import lookup as catalog_lookup
...
from app.utils.rules.classifier import classify
...
async def collect_context(state: dict[str, Any]) -> dict[str, Any]:
    ...
    if raw_evidence.sub_file_content:
        from app.utils.collectors.submit_dir import parse_healer_tags
